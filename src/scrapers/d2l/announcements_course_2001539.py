"""
Script to extract announcements from D2L course 2001539
Target URL: https://www.fanshaweonline.ca/d2l/lms/news/main.d2l?ou=2001539
"""
...
async def extract_course_2001539_announcements():
    """Extrai todos os anúncios do curso 2001539."""
    ...
    async with async_playwright() as p:
        ...
        try:
            print("="*80)
            print("EXTRATOR D2L - CURSO 2001539 - TODOS OS ANÚNCIOS")
            print("="*80)
            ...
            # ETAPA 2: Acessar página de notícias do curso 2001539
            print("[2/3] Acessando página de notícias do curso 2001539...")
            news_url = "https://www.fanshaweonline.ca/d2l/lms/news/main.d2l?ou=2001539"
            ...
            print("[3/3] Extraindo lista de anúncios...")
            ...
            # Extrair conteúdo de cada anúncio (TODOS, não apenas 5)
            print(f"Extraindo conteúdo de {len(announcements_list)} anúncios...")
            print("="*80 + "\n")
            ...
            # Salvar em arquivo dedicado para este curso
            output_dir = project_root / 'src' / 'data' / 'announcements'
            output_dir.mkdir(parents=True, exist_ok=True)
            output_path = output_dir / 'course_2001539_announcements.json'
            ...
            if all_announcements:
                ...
                output_dir = project_root / 'src' / 'data' / 'announcements'
                output_dir.mkdir(parents=True, exist_ok=True)
                partial_path = output_dir / 'course_2001539_partial.json'
...
if __name__ == "__main__":
    ...
    print("╔" + "="*78 + "╗")
    print("║" + " "*78 + "║")
    print("║" + "  EXTRATOR D2L - CURSO 2001539 - TODOS OS ANÚNCIOS".center(78) + "║")
    print("║" + " "*78 + "║")
    print("╚" + "="*78 + "╝")
    print("\n")

    result = asyncio.run(extract_course_2001539_announcements())

    print("\n" + "="*80)
    print("CONCLUÍDO COM SUCESSO!")
    print("="*80)
    print(f"Arquivo gerado: src/data/announcements/course_2001539_announcements.json")
